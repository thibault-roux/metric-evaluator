...
# test wer, semdist and cer only on utterances where the wer is not equal
...
def write(namefile, x, y, z):
    with open("results/complete/filter/WERCER/" + namefile + ".txt", "w", encoding="utf8") as file:
...
if __name__ == '__main__':
    ...
    dataset = read_dataset("wercer_filter_hats.txt")
